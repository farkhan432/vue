<template>
  <!-- Footer -->
  <b-footer color="unique-color-dark" class="page-footer font-small pt-0">
    ...
    <b-container fluid class="mt-5 mb-4 text-center text-md-left">
      <b-row class="mt-3">
        <b-col md="3" lg="4" xl="3" class="mb-4">
          <h6 class="text-uppercase font-weight-bold"><strong>Warung +62</strong></h6>
    ...
    <div class="footer-copyright text-center py-3">
      <b-container fluid>
        &copy; 2020 Copyright: <a href="https://www.MDBootstrap.com"> Warung+62 </a>
      </b-container>
    </div>
  </b-footer>
  <!-- Footer -->
